...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Books Listed</h4>
    </div>
...
<img src="./assets/bookimg/<?php echo htmlentities($result->bookImage);?>" width="100">
                                            ...
                                            <a href="comment.php?bookid=<?php echo htmlentities($result->bookid);?>"><button class="btn btn-primary"><i class="fa fa-edit "></i> Details </button> 
                                            <!-- <a href="details.php?bookid=<?php echo htmlentities($result->bookid);?>"><button class="btn btn-primary"><i class="fa fa-edit "></i> Comment </button>  -->
                                        </td>
                                        </tr>
 <?php $cnt=$cnt+1;}} ?>                                      
                                    </tbody>
