...
$sid=$_SESSION['stdid'];
// echo $sid;
$sql="SELECT StudentId,FullName,EmailId,MobileNumber,RegDate,UpdationDate,Status,avatar_filepath from  tblstudents  where StudentId=:sid ";
$query = $dbh -> prepare($sql);
$query-> bindParam(':sid', $sid, PDO::PARAM_STR);
$query->execute();
...
//   echo $avatarFilePath;
  if (!empty($avatarFilePath)) {
      // Display the existing avatar image
      echo '<img src="' . $avatarFilePath . '.png" alt="User Avatar" width="200" height="200">';
    //   echo '<img src="uploads/SID028.png" alt="User Avatar" width="200" height="200">';
  } else {
      // If avatar file is not found, display a default image or a placeholder
      echo '<img src="uploads/unnamed.png" alt="Default Avatar" width="200" height="200">';
  }
  ?>
</div>
